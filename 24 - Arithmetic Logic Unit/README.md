...
As the submarine starts booting up things like the [Retro Encabulator](https://youtu.be/RXJKdh1KZ0w), you realise that maybe you don't need all these submarine features after all.
